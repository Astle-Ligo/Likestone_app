...
router.get("/", verifyToken, authorizeRoles("Admin", "Manager","Supervisor"), getAllEmployees);
router.get("/:id", verifyToken, authorizeRoles("Admin", "Manager","Supervisor"), getEmployee);
...
// Added by Astle
router.patch("/:id", verifyToken, authorizeRoles("Admin", "Manager" ,"Supervisor"), patchEditEmployee);
